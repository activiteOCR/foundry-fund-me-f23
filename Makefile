...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account HotWallet --sender $(MY_ACCOUNT) --broadcast --verify --etherscan-api-key $(ETHER_API_KEY) -vvvv
...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --account HotWallet --sender $(MY_ACCOUNT) --broadcast --verify --etherscan-api-key $(ETHER_API_KEY) -vvvv
endif
